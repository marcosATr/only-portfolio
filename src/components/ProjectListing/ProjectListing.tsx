...
function ProjectListing({ data }: DataProps) {
  return (
    <Container maxW="container.xl" color="white">
      <Box py={8} _before={{ backgroundImage: "/images/bg2.webp", content: '" "', width: "1100px", height: "1100px", position: "absolute", top: "700px", left: "0", backgrounSize: "cover", zIndex: "-2", backgroundRepeat: "no-repeat", filter: "blur(20px)" }}>
